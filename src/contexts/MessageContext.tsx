...
interface MessageContextType {
    ...
    registerHandelOpenModal: (handler: (val: string, event?: any) => void) => void;
}
...
export const MessageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const registerHandelOpenModal = (handler: (val: string,viewMode:string, event?: any) => void) => {
    ...
    return (
        <MessageContext.Provider value={{ handelOpenModal, registerHandelOpenModal }}>
            {children}
