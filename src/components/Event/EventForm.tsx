        ...
        const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
            try {
                ...
                if (eventFormData.id) {
                    ...
                    // Création
                    const newId = await modelService.add(
                        "events",
                        eventFormData,
                    );
                    addToast({
                                        ...
                                        <div className="mt-2 grid grid-cols-4 gap-4">
                                            ...
                                            <div className="col-span-2">
                                                <SingleSelect
                                                    ...
                                                    value={
                                                        eventFormData.recurrence?.frequency_type?.toString() ??
                                                        ""
                                                    }
                                                />
                                            </div>
