...
import Dropdown from '../../Dropdown'; // Assumed Dropdown component path
import {
    dateStartOfDay,dateEndOfDay
} from '../../../helpers';
...
const EventCalendar = () => {
    ...
    const handlePrev = async () => {
        ...
        const { startDate, endDate } = getDateRange(newDate);
        fetchEvents(startDate, endDate);
    };
        ...
        <div className="event-calendar">
            <div className="toolbar flex items-center justify-between mb-4 mx-3">
                ...
                <div className="navigation-buttons flex items-center gap-2">
                    <button onClick={handlePrev} className="btn btn-outline-dark btn-sm">
                        {/*@ts-ignore*/}
                    ...
                    <button onClick={handleNext} className="btn btn-outline-dark btn-sm">
                        {/*@ts-ignore*/}
                        <FontAwesomeIcon icon={icons?.anglesRight} className="m-auto"/>
                    </button>
                </div>
                <div>
                    <button
