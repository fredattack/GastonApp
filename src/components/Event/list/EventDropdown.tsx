    ...
    return (
        <div className="dropdown flex justify-center items-center col-span-2">
            <Dropdown
                ...
                button={<FontAwesomeIcon icon={faEllipsisH} className="m-auto" />}
            >
                <ul className="!min-w-[170px] z-50 bg-white dark:bg-gray-800 shadow-lg rounded-md py-2">
                    <li>
                        <button type="button" className={`w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-700 ${donestyle}`} onClick={handleChangeDoneStatus}>
                            <FontAwesomeIcon icon={event.is_done ? faTimes : faCheckSquare} className="mr-2" />
                            {event.is_done ? 'Mark as Undone' : 'Mark as Done'}
                        </button>
                    </li>
                    <li>
                        <button type="button" className="w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-700" onClick={handleEdit}>
                            <FontAwesomeIcon icon={faEdit} className="mr-2" />
                            Edit Event
                        </button>
                    </li>
                    <li>
                        <button type="button" className="w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-700 text-red-600" onClick={onDelete}>
