...
export default function DisplaySettingsDropdown({ viewMode, onChangeViewMode,onChangeViewStyle }: { viewMode: string, onChangeViewMode: (mode: string) => void , onChangeViewStyle: (mode: string) => void }) {
    return (
