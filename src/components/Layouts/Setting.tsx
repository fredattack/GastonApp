    ...
    return (
        <div>
            ...
            >
                <button
                    type="button"
                    className="bg-primary ltr:rounded-tl-full rtl:rounded-tr-full ltr:rounded-bl-full rtl:rounded-br-full absolute ltr:-left-16 rtl:-right-16 top-0 bottom-0 my-auto w-12 h-10 flex justify-center items-center text-white cursor-pointer"
                ...
                <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
                    <div className="text-center relative pb-5">
                        ...
                        <p className="text-white-dark">
                            Set preferences that will be cookied for your live
                        ...
                        <div className="mt-5 text-primary">
                            <label className="inline-flex mb-0">
                                <input
                                    ...
                                    onChange={(e) =>
                                        dispatch(
                                            toggleSemidark(e.target.checked),
                                        )
                                    }
                                />
                        ...
                        <div className="mt-3 flex items-center gap-3 text-primary">
                            ...
                            <label className="inline-flex mb-0">
                                <input
                                    ...
                                    className="form-radio"
                                    onChange={() =>
                                        dispatch(toggleNavbar("navbar-static"))
                                    }
                                />
                                <span>Static</span>
                            </label>
