...
const ComponentsShowcase: React.FC = () => {
    return (
        <div
            ...
            style={{ background: "var(--color-lin-2)" }}
        >
            <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
                ...
                <div className="mb-12">
                    ...
                    >
                        Démonstration des composants UI du design system
                        GastonApp
                    </p>
                </div>
                    ...
                    <div className="mb-8">
                        ...
                        <Card variant="standard" padding="md">
                            ...
                            <p style={{ color: "var(--color-neutral-600)" }}>
                                This is a standard card with white background
                                and subtle shadow. Perfect for content sections
                    ...
                    <div className="mb-8">
                        ...
                        <Card variant="glass" padding="lg">
                            ...
                            <p style={{ color: "var(--color-neutral-700)" }}>
                                This is a glass card with frosted glass effect
                                (backdrop-filter blur). Great for overlays and
                                modern UI designs.
                            </p>
                        </Card>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <p className="text-white/90">
                                    Soft mint to lavender gradient. Calming and
                                    elegant.
                                </p>
                            </Card>
                            ...
                            >
                                ...
                                >
                                    Fresh mint to white gradient. Clean and
                                    modern.
                                </p>
                            </Card>
                            ...
                            >
                                ...
                                <p className="text-white/90">
                                    Vibrant purple gradient for activity cards.
                                    Bold and energetic.
                                </p>
                            </Card>
                            ...
                            >
                                ...
                                >
                                    Warm yellow gradient for cheerful
                                    activities.
                                </p>
                            </Card>
                            ...
                            >
                                ...
                                <p className="text-white/90">
                                    Coral gradient for health and wellness
                                    activities.
                                </p>
                            </Card>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <Card variant="standard" padding="none">
                                <div style={{ padding: "16px" }}>
                                    ...
                                    >
                                        No padding (custom padding applied)
                                    </p>
                                </div>
                            </Card>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <p className="text-white/90 mb-4">
                                Register your pet and keep track of their
                                health, activities, and important dates.
                            </p>
                            <Button
                                variant="secondary"
                                icon={<Plus />}
                        ...
                        >
                            ...
                            <p className="text-white/90 mb-4">
                                All components are ready to use. Start building
                                amazing pet management experiences.
                            </p>
                            <Button
                                variant="secondary"
                                icon={<ArrowRight />}
